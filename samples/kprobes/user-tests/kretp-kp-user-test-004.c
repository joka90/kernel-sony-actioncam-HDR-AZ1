...
/**
 *
 *@@ TestName - kretp-kp-user-test-004.c
 *
 *@brief
 ...
 *
 * Note : This testcase will insert the kretp-kp-test-004.ko which
...
int main()
{
	...
	system("modprobe kretp-kp-test-004");
	...
	system("rmmod kretp-kp-test-004");
