 ...
 *		     gettimeofday().
 *
 * This testcase when executed with the kprobe module k-009, which is
 * having only pre-handler and post-handler,will give the overhead due
 * to both the handlers.
 *
 *@pre
