 ...
 * Copyright (C) FUJITSU SEMICONDUCTOR LTD. 2012. All rights reserved.
 *
...
#ifdef CONFIG_ARCH_NE1
#include "ohci-ne1.c"
#define PLATFORM_DRIVER		ohci_hcd_ne1_driver
#endif

#ifdef CONFIG_ARCH_CXD90014
#include "ohci-f_usb20ho.c"
#define PLATFORM_DRIVER		ohci_hcd_f_usb20ho_driver
#endif
