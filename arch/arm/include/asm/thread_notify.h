/* 2012-03-05: File changed by Sony Corporation */
/*
...
#ifndef CONFIG_EJ_NO_THREAD_NOTIFIER
...
#else
#define thread_register_notifier(n) do{(void)(n);-EPERM;}while(0)
#define thread_unregister_notifier(n) do{(void)(n);-EPERM;}while(0)
#define thread_notify(rc, thread) do{(void)(rc);(void)(thread);}while(0)
#endif
