...
#ifdef CONFIG_ARM_ERRATA_769221
#define errata_769221_workaround() do { \
	asm("mcr p15, 0, %0, c8, c3, 1" : : "r" (0) : "cc"); \
	dsb(); } while (0)
#endif
...
#ifdef CONFIG_ARCH_CXD90014BASED
static inline void flush_pmd_range(pmd_t *s, pmd_t *e)
{
	const unsigned int __tlb_flag = __cpu_tlb_flags;
	pmd_t *p;

	if (tlb_flag(TLB_DCLEAN)) {
		clean_dcache_area(s, (void *)e - (void *)s);
	}
...
static inline void local_flush_tlb_kernel_range(unsigned long s,
	unsigned long e)
{
