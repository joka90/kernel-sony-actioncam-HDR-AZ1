...
#else
#define PAGE_OFFSET		(UL(CONFIG_PAGE_OFFSET) + UL(0x01000000))
...
#define EARLY_PFN_TO_NID(pfn)	early_pfn_to_nid(pfn)
#else
#define EARLY_PFN_TO_NID(pfn)	PFN_TO_NID(pfn)
#endif /* CONFIG_ARCH_POPULATES_NODE_MAP */

#define EARLY_PHYS_TO_NID(addr) EARLY_PFN_TO_NID((addr) >> PAGE_SHIFT)
