...
#endif
  BLANK();
  DEFINE(TU_THREAD_INFO,	offsetof(union thread_union, thread_info));
  DEFINE(THREAD_INFO_SZ,	sizeof(struct thread_info));
  DEFINE(TI_FLAGS,		offsetof(struct thread_info, flags));
  DEFINE(TI_PREEMPT,		offsetof(struct thread_info, preempt_count));
#ifdef CONFIG_THREAD_INFO_INDIRECT
  DEFINE(TI_TI_PTR,		offsetof(struct thread_info, ti_ptr));
#endif
