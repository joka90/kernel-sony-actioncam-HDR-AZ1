/* 2010-11-29: File changed by Sony Corporation */
...
#define __define_initcall(level,fn,id)				\
	static int __init __boottime_##fn(void) {			\
 		boot_time_add(#fn);					\
 		return fn();						\
 	}								\
	static initcall_t __initcall_##fn##id __used \
 	__attribute__((__section__(".initcall" level ".init"))) = __boottime_##fn
