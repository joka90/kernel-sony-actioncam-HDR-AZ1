...
extern unsigned long reserve_mem_nr_map;
extern int is_ext_reserved_area(unsigned long phys);
extern int is_range_reserved_area(unsigned long start_addr, unsigned long end_addr);
#else
#define is_ext_reserved_area(x) 0
