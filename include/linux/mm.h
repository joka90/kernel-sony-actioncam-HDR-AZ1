...
struct scan_control {
	...
	/* If non-zero, all pages are certainly scanned. */
	int force_scan;
};
...
unsigned long shrink_page_list(struct list_head *page_list,
			       struct zone * zone,
			       struct scan_control *sc);
#endif /* CONFIG_SNSC_MM_WAIT_PAGEWRITEBACK */
...
#ifdef CONFIG_SNSC_SECTION_NR_OUT_OF_PAGE_FLAG
#if SECTIONS_SHIFT > 16
#error Section size is too small.
#endif
#else
#if SECTIONS_WIDTH+NODES_WIDTH+ZONES_WIDTH > BITS_PER_LONG - NR_PAGEFLAGS
#error SECTIONS_WIDTH+NODES_WIDTH+ZONES_WIDTH > BITS_PER_LONG - NR_PAGEFLAGS \
please check CONFIG_SNSC_SPARSE_SECTION_SHIFT OR set CONFIG_SNSC_SECTION_NR_OUT_OF_PAGE_FLAG
#endif
#endif
...
int get_user_pages_noncoherent_fast(unsigned long start, int nr_pages,
...
#ifdef CONFIG_EJ_GUP_EXPAND
#define FOLL_DONTNEED_ICACHE_COHERENCY 0x1000
#endif /* CONFIG_EJ_GUP_EXPAND */
...
extern void set_reclaim_mode(int priority, struct scan_control *sc,
				   bool sync);
#endif /* __KERNEL__ */
#endif /* _LINUX_MM_H */
