...
#define inet_metrics_new(a) (0)
static inline struct inet_peer *inet_getpeer_v4(__be32 v4daddr, int create) { return NULL; }
#define inet_getpeer_v6(a, b) (0)
static void inline inet_initpeers(void) { }
static inline void inet_peer_refcheck(const struct inet_peer *p) { }
#define inet_peer_xrlim_allow(a, b) (0)
#define inet_getid(a, b) (0)
#define inet_putpeer(a) do { } while (0)
