/* 2012-04-11: File added and changed by Sony Corporation */
/*
...
/* Standard probes */
void probe_irq_tasklet_entry(void *_data, struct tasklet_struct *t)
{
	trace_mark_tp(kernel, tasklet_entry, irq_tasklet_entry,
		probe_irq_tasklet_entry, "func %p data %lu",
		t->func, t->data);
}

void probe_irq_tasklet_exit(void *_data, struct tasklet_struct *t)
{
	trace_mark_tp(kernel, tasklet_exit, irq_tasklet_exit,
		probe_irq_tasklet_exit, "func %p data %lu",
		t->func, t->data);
}
